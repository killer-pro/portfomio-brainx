...
export const teamMembers = [
...

    {
        ...
        image: moussa,
        email: "seyem@ept.sn",
        linkedin: "https://www.linkedin.com/in/moussa-seye-6477a8249/",
        github: "https://github.com/MoussaTorch",
        bio: "Computer science engineer, avec une passion à l'IA et le développement de LLMs,je suis passionnée par les solution complexe, l'algorithme, les recherches et le développement de logiciels.",
        biography: [
            "Ma passion pour l'intelligence artificielle s'est manifestée très tôt dans mon parcours académique. Fasciné par la capacité des machines à apprendre et à s'adapter, j'ai orienté mes études vers ce domaine prometteur qui transforme notre monde à un rythme sans précédent.",
            "Ce qui me motive particulièrement dans l'IA, c'est son potentiel à résoudre des problèmes complexes qui semblaient autrefois insurmontables. Les modèles de langage (LLMs) représentent pour moi l'une des avancées les plus fascinantes dans ce domaine, combinant linguistique et apprentissage automatique de manière remarquable.",
            "À l'École Polytechnique de Thiès, j'ai eu l'opportunité de développer mes compétences tant théoriques que pratiques. J'ai participé à plusieurs projets de recherche qui m'ont permis d'approfondir mes connaissances en apprentissage automatique et en traitement du langage naturel.",
            "Mon stage chez Sonatel en tant que ML engineer a été une expérience formative inestimable. Travailler sur un système de reconnaissance continue de la langue des signes m'a permis de comprendre les défis réels de l'application de l'IA dans un contexte d'accessibilité. Ce projet, allant de la modélisation au déploiement sur une interface web, a renforcé ma conviction que l'IA peut véritablement améliorer la vie des personnes."
        ],
        skills: [
            "Cybersécurité",
            "Développement Web (Spring Boot, Django, Angular, React)",
            ...
            "Réseaux & Protocoles",
            "Systèmes Embarqués (ESP32, Arduino)",
            "Intelligence Artificielle & Machine Learning (TensorFlow, PyTorch)"
        ],
        experience: [{
            "role": "Stagiaire",
            "company": "Sonatel",
            "period": "Août 2024 - Décembre 2024",
            "description": "ML engineer au sein du Data/AI-Business-Management, j'étais chargé de développer un système de reconnaissance continue de la langue des signes. De la modélisation jusqu'au déploiement sur un interface web."
        }],
        education: [{
            "degree": "DIC2 (2e année de spécialisation)",
            "school": "École Polytechnique de Thiès",
