export const teamMembers = [
  {
    ...
    email: "khadidiatou.diome@ept.sn",
    linkedin: "https://linkedin.com/in/khadidiatou-diome",
    github: "https://github.com/khadidiatou-diome",
    bio: "Software Engineering student at École Polytechnique de Thiès, specializing in Computer Science and Telecommunications.",
    skills: ["JavaScript", "React", "Node.js", "Python", "Network Programming", "Database Management"],
    experience: [
      {
        role: "Software Engineering Intern",
        company: "Sonatel",
        period: "June 2023 - August 2023",
        description: "Developed telecommunications network monitoring systems and implemented network optimization solutions."
      }
    ],
    education: [
      {
        ...
        period: "2021 - Present",
        description: "Specializing in software engineering and telecommunications systems."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    email: "abdoulkarim.ly@ept.sn",
    linkedin: "https://linkedin.com/in/abdoulkarim-ly",
    github: "https://github.com/abdoulkarim-ly",
    bio: "Engineering student focused on software development and telecommunications systems.",
    skills: ["Python", "React", "Network Protocols", "System Administration", "Database Design"],
    experience: [
      {
  ...
  },
  {
    ...
    email: "moussa.seye@ept.sn",
    linkedin: "https://linkedin.com/in/moussa-seye",
    github: "https://github.com/moussa-seye",
    bio: "Engineering student specializing in software development and telecommunications.",
    skills: ["Python", "React", "Network Security", "Database Management", "DevOps"],
    experience: [
      {
        role: "Software Engineering Intern",
        company: "Sonatel",
        period: "June 2023 - August 2023",
        description: "Worked on telecommunications software development and network optimization."
      }
    ],
    education: [
      {
        ...
        school: "École Polytechnique de Thiès",
        period: "2021 - Present",
        description: "Specializing in software and telecommunications engineering."
      }
    ]
  }
];